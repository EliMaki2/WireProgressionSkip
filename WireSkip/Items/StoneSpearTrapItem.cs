...
{
    // This is the item that places the Stone Spear Trap tile
    public class StoneSpearTrapItem : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<Tiles.StoneSpearTrap>(); // the tile it places
        }
