...
{
    // This is the item that places the Lunar Flame Trap tile
    public class LunarFlameTrapItem : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<Tiles.LunarFlameTrap>(); // the tile it places
        }
