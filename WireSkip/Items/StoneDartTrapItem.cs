...
{
    // This is the item that places the Stone Dart Trap tile
    public class StoneDartTrapItem : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<Tiles.StoneDartTrap>(); // the tile it places
        }
