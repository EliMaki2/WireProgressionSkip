...
{
    // This is the item that places the Stone Spike Ball Trap tile
    public class StoneSpikeBallTrapItem : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.value = Item.buyPrice(gold: 1); // base value
            Item.rare = ItemRarityID.Blue;       // item rarity
            Item.createTile = ModContent.TileType<Tiles.StoneSpikeBallTrap>(); // the tile it places
        }
