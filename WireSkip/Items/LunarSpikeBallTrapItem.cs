...
{
    // This is the item that places the Lunar Spike Ball Trap tile
    public class LunarSpikeBallTrapItem : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<Tiles.LunarSpikeBallTrap>(); // the tile it places
        }
