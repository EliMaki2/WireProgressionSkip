...
{
    // This is the item that places the Stone Flame Trap tile
    public class StoneFlameTrapItem : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<Tiles.StoneFlameTrap>(); // the tile it places
        }
