...
{
    public class StoneSpikeBallTrapTE : ModTileEntity
    {
        private int cooldown = 0;
        private const int MAX_COOLDOWN = 120; // doubled cooldown
        ...
        public override bool IsTileValidForEntity(int i, int j)
            => Main.tile[i,j].HasTile && Main.tile[i,j].TileType == ModContent.TileType<Tiles.StoneSpikeBallTrap>();
